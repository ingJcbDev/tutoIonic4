...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-lg">Tu web</span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        @php
            ...
            $contactPublic = TblContactoPublicacion::all();
            $i = 0;
            foreach ($contactPublic as $contact){
                if ($contact->estado == "leer"){
                    $i++;
                }
            }
        @endphp
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    <!-- Menu toggle button -->
                    <a href="{{ url('admin/mensajes') }}" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fa fa-envelope-o"></i>
                        <span class="label label-success">{{$i}}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="header">Usted tiene {{$i}} mensajes sin leer</li>
                        <!--<li>
                        ...
                        <li class="footer"><a href="{{ url('admin/mensajes') }}">Ir A Mensajes</a></li>
                    </ul>
                </li><!-- /.messages-menu -->
